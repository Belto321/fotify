            ...
            <Dialog.Portal>
                ...
                className="bg-neutral-900/90 backdrop-blur-sm fixed inset-0"
                 ...
                 className="fixed drop-shadow-md border border-neutral-700 top-[50%] left-[50%] max-h-full h-full md:h-auto md:max-h-[85vh] w-full md:w-[90vw] md:max-w-[450px] translate-x-[-50%] translate-y-[-50%] rounded-md bg-neutral-800 p-[25px] focus:outline-none">
                    ...
                    <Dialog.Description
                    className="mb-5 test-sm text-center leading-normal"
                    >
                        {description}
                    </Dialog.Description>
                    <div>
                    ...
                    <Dialog.Close asChild>
                        <button
                        onClick={onClose}
                        className="text-neutral-400 hover:text-white absolute top-[10px] right-[10px] inline-flex h-[25px] w-[25px] appearence-none items-center justify-center rounded-full focus:outline-none"
                        >
                            <IoMdClose/>
                        </button>
                    </Dialog.Close>
